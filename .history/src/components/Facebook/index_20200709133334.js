...
export default class LoginFacebook extends Component {
  ...
  componentDidMount() {
    fetch("https://cors-anywhere.herokuapp.com/https://api.couponfeed.co/auth/login/success", {
      method: "GET",
      credentials: "include",
      headers: {
  ...
  componentClicked = () => {
    window.open("https://cors-anywhere.herokuapp.com/https://api.couponfeed.co/facebook", "_self");
    // console.log("clicked")
  }
  render() {
    let facebookData;
